...
INSERT INTO `messages` (`id`, `message`, `user_from`, `user_to`, `created`,
                        `created_by`)
VALUES (1, 'Message from 1 to 2', 1, 2, '2022-05-17 10:05:08', 1),
...
INSERT INTO `friends` (`id`, `user_id`, `friend_id`, `friend date`, `created`,
                       `created_by`)
VALUES (1, 1, 2, '2022-05-17 12:59:33', '2022-05-17 12:59:33', 1),
...
INSERT INTO `users` (`id`, `name`, `login`, `pass`, `created`, `created_by`)
VALUES (1, 'Vasia', 'vasia', '202cb962ac59075b964b07152d234b70', '2022-05-17 09:55:50', 1),
...
ALTER TABLE `messages`
  ...
  ADD CONSTRAINT `messages_to_user` FOREIGN KEY (`user_to`) REFERENCES `users` (`id`) ON
UPDATE CASCADE;
...
ALTER TABLE `friends`
  ...
  ADD CONSTRAINT `friends_to_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON
UPDATE CASCADE;
COMMIT;
